...
TOKEN = '7815797882:AAGJvpswE1gBGZFwSj3y08h8YIBHLen8jUg'
MONGO_URI = 'mongodb+srv://progamerddos: progamerddos@progamerddos.ccgqx.mongodb.net/?retryWrites=true&w=majority&appName=progamerddos'
FORWARD_CHANNEL_ID = -1002357890235
CHANNEL_ID = -1002357890235
error_channel_id = -1002357890235

logging.basicConfig(format='%(asctime)s - %(name)s - %(levelname)s - %(message)s', level=logging.INFO)

client = MongoClient(MONGO_URI, tlsCAFile=certifi.where())
db = client['progamerddos']
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :- @Navin_pre*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@Navin_pre*", parse_mode='Markdown')
    else:
